...
/*
  ...
  deployment is live at this domain the fetch fails fast and every section
  falls back, which renders today's page exactly. SCOOPLIST_FEED_URL
  overrides for local testing against a local Scooplist.
*/
